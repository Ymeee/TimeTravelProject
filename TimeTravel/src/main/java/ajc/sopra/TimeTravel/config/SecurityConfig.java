	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		return http.antMatcher("/**")
			...
			.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET,"/api/auth","/api/passager/**","/api/client/**").authenticated()
				...
				.antMatchers(HttpMethod.POST, "/api/reservation/**","/api/passager/**", "/api/client/**").hasRole("Client")
				.antMatchers(HttpMethod.DELETE, "/api/passager/**").hasRole("Client")
